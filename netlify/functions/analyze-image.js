...
exports.handler = async (event) => {
  ...
  try {
    ...
    const response = await fetch(
      `https://generativelanguage.googleapis.com/v1beta/models/gemini-1.5-flash:generateContent?key=${apiKey}`,
      {
        ...
        body: JSON.stringify({
          contents: [{
            parts: [
              { text: "Analyze PPE: Hairnet, Mask, Protective suit, Gloves, Safety shoes. Return JSON: {findings:[{ppeItem:string,compliant:boolean,reason:string(Arabic),boundingBox:{x:0.1,y:0.1,width:0.2,height:0.2}}],summary:string(Arabic),overallCompliant:boolean}" },
    ...
    try {
      ...
      result = {
        findings: [{ ppeItem: "Hairnet", compliant: false, reason: "فشل", boundingBox: { x: 0, y: 0, width: 1, height: 1 } }],
        summary: "خطأ",
